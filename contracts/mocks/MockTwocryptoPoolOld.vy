...
"""Old-pool-like mock (same admin surface as poolold.vy)."""
...
def __init__(_factory: address):
    ...
    # start with non-trivial defaults
    self.mid_fee = 1_000_000
    self.out_fee = 2_000_000
    self.fee_gamma = 111
    self.allowed_extra_profit = 222
    self.adjustment_step = 333
    self.ma_time = 444
